<template>
  ...
  >
    <button
      class="flex flex-row items-center justify-center border-none cursor-pointer bg-primary-100 hover:bg-primary-100/70 font-bold text-white w-[3.125rem] h-[3.125rem] rounded-full"
      @click="goToProfile"
    >
